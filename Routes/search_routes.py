...
@router.get("/search/", status_code=status.HTTP_200_OK, response_model=List[Search.SearchBase])
...
@router.get("/search/{request_id}", status_code=status.HTTP_200_OK, response_model=Search.SearchBase)
